     ...
     <div class="row">
        <div class="col-12 mb-2 mt-2">商品名
            <div class="form-group">
                <input type="text" name="name" value="<?php echo e($product->name); ?>" class="form-control" placeholder="名前">
            ...
            <div class="form-group">メーカー名
                <select name="company" class="form-select">
                    ...
                    <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($company->id); ?>"><?php echo e($company->company_name); ?></otion>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-12 mb-2 mt-2">
            <div class="form-group">価格
                <input type="text" name="price" value="<?php echo e($product->price); ?>"class="form-control" placeholder="価格">
...
unset($__errorArgs, $__bag); ?>
        ...
        <ul style="display: flex; list-style: none; padding: 40px;">
            <li style="margin-right: 30px;">
                <a class="btn btn-success" href="<?php echo e(url('/products')); ?>">新規登録</a>
            </li>
            <li style="margin-right: 30px;">
                <a class="btn btn-success" href="<?php echo e(url('/products')); ?>">　戻る　</a>
            </li>
        </ul>
...
</html><?php /**PATH C:\xampp\htdocs\admin\resources\views/product/edit.blade.php ENDPATH**/ ?>