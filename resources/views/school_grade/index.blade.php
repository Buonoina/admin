...
<div class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-success" href="{{ route('school_grade.create') }}">新規登録</a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <td style="text-align:right">{{ $school_grade->grade }}</td>
            <td style="text-align:right">{{ $school_grade->term }}</td>
